...
public class ScriptRunner
    ...
    static String typeToString(int t) {
        switch (t) {
            case SCRIPT_TYPE_ON_DEMAND:
                return XML_SCRIPT_TYPE_ONDEMAND;
            case SCRIPT_TYPE_AFTER_INIT:
                return XML_SCRIPT_TYPE_AFTERINIT;
            case SCRIPT_TYPE_BEFORE_INIT:
                return XML_SCRIPT_TYPE_BEFOREINIT;
            default:
                return null;
        }
    }
