...
class TiltLabel
    ...
    private void loadImages() {
        URL grayIconUrl = ResourceUtils.getResource("img/grayTilt.png");
        URL greenIconUrl = ResourceUtils.getResource("img/greenTilt.png");
        URL yellowIconUrl = ResourceUtils.getResource("img/yellowTilt.png");
        URL redIconUrl = ResourceUtils.getResource("img/redTilt.png");
